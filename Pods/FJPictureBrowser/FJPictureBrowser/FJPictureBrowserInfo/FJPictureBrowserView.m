...
- (nullable UIView *)scrollView:(nonnull TMMuiLazyScrollView *)scrollView itemByMuiID:(nonnull NSString *)muiID;
{
    ...
    FJPictureBrowserPhotoView *cell = (FJPictureBrowserPhotoView *)[scrollView dequeueReusableItemWithIdentifier:@"FJPictureBrowserPhotoView"];
    NSInteger index = [muiID integerValue];
    if (!cell) {
        cell = [[FJPictureBrowserPhotoView alloc] init];
